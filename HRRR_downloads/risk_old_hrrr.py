...
# List of dates from archive begining to 9 months ago. These are the dates we
# want to risk on the Pando archive and not backup on horel-group7.
#sDATE = datetime(2016, 7, 15) # Begining of archive...
sDATE = datetime.now()-timedelta(days=273)
eDATE = datetime.now()-timedelta(days=270)
...
RISK = ['f01', 'f02', 'f03', 'f04', 'f05', 'f07', 'f08', 'f09', 'f10', 'f11', 'f13', 'f14', 'f15', 'f16', 'f17', 'f18']
